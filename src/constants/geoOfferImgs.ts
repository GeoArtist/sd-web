...
import inne from '@/public/images/geo_offer/inne.jpg'
import inwentaryzacje from '@/public/images/geo_offer/inwentaryzacje.jpg'
...
export const geoOfferImgs:ImgsLinks[] = [{
    url: inne,
    alt: 'inne'
},{
    url: inwentaryzacje,
